  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link href={"/"} className="w-full flex gap-2 justify-left items-center">
        ...
        <span className="font-semibold dark:text-white text-lg">Spectra</span>
      </Link>
      ...
      <aside className="flex w-full gap-2 justify-end">
        <Link href={"/login"}>
          <Button
            ...
            className="text-base p-1 hidden sm:block"
          >
            Login
          </Button>
        </Link>
        <Link href="/signup">
          <Button variant="btn-primary" className="text-base whitespace-nowrap">
            Sign Up
          </Button>
        </Link>
      </aside>
